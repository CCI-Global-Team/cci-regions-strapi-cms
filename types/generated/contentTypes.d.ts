...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutCCICanada: Schema.Attribute.Component<
      'section.about-cci-canada',
      false
    > &
    ...
    pageName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'AboutPage'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    country: Schema.Attribute.Enumeration<['Canada']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Schema.Attribute.DefaultTo<'Canada'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    streetLine1: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiBankBank extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    countryCode: Schema.Attribute.Enumeration<['CA', 'US', 'GB', 'AU']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiCampusCampus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    inceptionDate: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    midweekDay: Schema.Attribute.Enumeration<
    ...
    > &
      ...
      Schema.Attribute.DefaultTo<'Wednesday'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    pastors: Schema.Attribute.Relation<'oneToMany', 'api::pastor.pastor'>;
    phone: Schema.Attribute.Integer &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    resident: Schema.Attribute.Relation<'oneToOne', 'api::pastor.pastor'>;
    sundayServiceTimes: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    type: Schema.Attribute.Enumeration<['campus', 'cell-church']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiCommunityPageCommunityPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    interestGroups: Schema.Attribute.Component<
    ...
    >;
    maps: Schema.Attribute.Component<'section.maps', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    pageName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'CommunityPage'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiConnectPageConnectPage extends Struct.SingleTypeSchema {
  collectionName: 'connect_pages';
  info: {
    displayName: 'ConnectPage';
    pluralName: 'connect-pages';
    singularName: 'connect-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    address: Schema.Attribute.Relation<'oneToOne', 'api::address.address'>;
    bannerImage: Schema.Attribute.Media<'images' | 'videos'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiFixedEventFixedEvent extends Struct.CollectionTypeSchema {
  collectionName: 'fixed_events';
  info: {
    displayName: 'FixedEvent';
    pluralName: 'fixed-events';
    singularName: 'fixed-event';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGetInvolvedPageGetInvolvedPage
  ...
  attributes: {
    becomeAMember: Schema.Attribute.Component<
    ...
    joinServiceUnit: Schema.Attribute.Component<
      'section.join-service-unit',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiGivePageGivePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    givingSection: Schema.Attribute.Component<'section.start-giving', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGivingOptionGivingOption
  extends Struct.CollectionTypeSchema {
  collectionName: 'giving_options';
  info: {
    displayName: 'GivingOption';
    pluralName: 'giving-options';
    singularName: 'giving-option';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    sortCode: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    type: Schema.Attribute.Enumeration<
      ['redirect', 'sms', 'bank_transfer', 'contact', 'informational']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiGroupLeaderGroupLeader extends Struct.CollectionTypeSchema {
  collectionName: 'group_leaders';
  info: {
    displayName: 'GroupLeader';
    pluralName: 'group-leaders';
    singularName: 'group-leader';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    latestMessages: Schema.Attribute.Component<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    waysToConnect: Schema.Attribute.Component<
      'section.ways-to-connect',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiLocationsPageLocationsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    locations: Schema.Attribute.Component<'section.locations', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    pageName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'LocationsPage'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMapMap extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    areasCovered: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPastorPastor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pastor.pastor'>;
...
export interface ApiSermonSermon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::sermon.sermon'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::giving-option.giving-option': ApiGivingOptionGivingOption;
